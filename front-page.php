...
<div id="front-page-carousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption custom-caption">
        <h3 class="display-5 text-white fw-bold">Your Partner in Interconnection Solutions</h3>
        <p class="lead fw-normal text-white mt-4">Our mission is to foster long-term partnerships with our clients,
          delivering high-quality interconnection solutions and unparalleled after-sales service for mutual success.</p>
        <a href="#services" class="btn btn-success btn-lg mt-3">View More</a>
      </div>
    </div>
  </div>
